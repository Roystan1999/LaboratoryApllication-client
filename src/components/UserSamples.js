...
const samplesData=async()=>{
  ...
  return (
      <div>
 <div class="input-group rounded" style={{width:'30%',marginTop:"40px",position:'relative',left:'30%'}}>
  <input type="search" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" onChange={(e)=>{setsearchValue(e.target.value)}} />
